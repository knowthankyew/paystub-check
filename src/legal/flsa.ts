...
export const FLSA_RULES: FLSARule[] = [
  ...
  },
  {
    ...
    explanation: "Simply paying an employee a salary does NOT make them exempt from overtime. To be exempt, an employee must earn at least the governing statutory threshold (binding federal floor is $684/wk or $35,568/yr following the nationwide vacatur of the 2024 rule, with higher state thresholds like CA $66,560, WA $67,725, or NY $62,400 taking precedence) AND perform bona fide executive, administrative, or professional duties.",
